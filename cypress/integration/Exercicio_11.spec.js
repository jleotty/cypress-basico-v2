...
describe('exibe mensagem de erro ao submeter o formulário com um email com formatação inválida', function() {
    ...
    cy.get('#product').select(1).should('have.value','blog') //adicionei a classe do botão de seleção, apontei o tipo ".select" e procurei pelo o nome da opção, logo após validei se o nome youtube está mesmo.
